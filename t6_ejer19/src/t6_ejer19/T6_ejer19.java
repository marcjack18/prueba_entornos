...
public class T6_ejer19 {
	...
	public static void main(String[] args) {
		...
		case 2:
			System.out.println("De que posicion quieres cambiar el nombre");
			posicion_nombre=entrada.nextInt();
			System.out.println("Que nuevo nombre quieres?");
			nombre=entrada.nextLine();
			lista.set(posicion_nombre,nombre);
			break;
